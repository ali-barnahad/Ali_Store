...
function Stickers({ products }) {
  ...
  return (
    <>
      <Head>
        <title>{t("stickersPageTitle")}</title>
        <meta name="description" content={t("stickersPageDescription")} />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content={t("stickersPageTitle")} />
        <meta
          property="og:description"
          content={t("stickersPageDescription")}
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://alistore.liara.run/stickers" />
        <meta
          property="og:image"
          content="https://alistore.liara.run/images/stickers-og-image.jpg"
        />
        <link rel="canonical" href="https://alistore.liara.run/stickers" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
            url: "https://alistore.liara.run/stickers",
            name: t("stickersPageTitle"),
            description: t("stickersPageDescription"),
