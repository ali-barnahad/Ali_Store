  ...
  return (
    <Layout user={user}>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://sticker-next.liara.run/panelUser/wishList`}
        />
        <meta
          property="og:image"
          content={`https://sticker-next.liara.run/images/wishlist-og-image.jpg`}
        />
        <link
          rel="canonical"
          href={`https://sticker-next.liara.run/panelUser/wishList`}
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "url": "https://sticker-next.liara.run/panelUser/wishList",
