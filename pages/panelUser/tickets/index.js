  ...
  return (
    <Layout user={user}>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://alistore.liara.run/panelUser/tickets`}
        />
        <meta
          property="og:image"
          content={`https://alistore.liara.run/images/tickets-og-image.jpg`}
        />
        <link
          rel="canonical"
          href={`https://alistore.liara.run/panelUser/tickets`}
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "url": "https://alistore.liara.run/panelUser/tickets",
