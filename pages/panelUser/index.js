  ...
  return (
    <Layout user={user}>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://sticker-next.liara.run/panelUser`}
        />
        <meta
          property="og:image"
          content={`https://sticker-next.liara.run/images/user-panel-og-image.jpg`}
        />
        <link
          rel="canonical"
          href={`https://sticker-next.liara.run/panelUser`}
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "url": "https://sticker-next.liara.run/panelUser",
