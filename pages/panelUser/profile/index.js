  ...
  return (
    <Layout user={user}>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://sticker-next.liara.run/panelUser/profile`}
        />
        <meta
          property="og:image"
          content={`https://sticker-next.liara.run/images/profile-og-image.jpg`}
        />
        <link
          rel="canonical"
          href={`https://sticker-next.liara.run/panelUser/profile`}
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "url": "https://sticker-next.liara.run/panelUser/profile",
