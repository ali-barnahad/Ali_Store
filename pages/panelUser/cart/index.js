  ...
  return (
    <Layout user={user}>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://sticker-next.liara.run/panelUser/cart`}
        />
        <meta
          property="og:image"
          content={`https://sticker-next.liara.run/images/cart-og-image.jpg`}
        />
        <link
          rel="canonical"
          href={`https://sticker-next.liara.run/panelUser/cart`}
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "url": "https://sticker-next.liara.run/panelUser/cart",
