  ...
  return (
    <Layout user={user}>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://alistore.liara.run/panelUser/comments`}
        />
        <meta
          property="og:image"
          content={`https://alistore.liara.run/images/comments-og-image.jpg`}
        />
        <link
          rel="canonical"
          href={`https://alistore.liara.run/panelUser/comments`}
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "url": "https://alistore.liara.run/panelUser/comments",
