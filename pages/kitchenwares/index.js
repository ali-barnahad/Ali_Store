...
function Kitchenwares({ products }) {
  ...
  return (
    <>
      <Head>
        <title>{t("kitchenwaresPageTitle")}</title>
        <meta name="description" content={t("kitchenwaresPageDescription")} />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content={t("kitchenwaresPageTitle")} />
        <meta
          property="og:description"
          content={t("kitchenwaresPageDescription")}
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://alistore.liara.run/kitchenwares"
        />
        <meta
          property="og:image"
          content="https://alistore.liara.run/images/kitchenwares-og-image.jpg"
        />
        <link rel="canonical" href="https://alistore.liara.run/kitchenwares" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "ItemList",
              "url": "https://alistore.liara.run/kitchenwares",
              "name": "${t("kitchenwaresPageTitle")}",
              "description": "${t("kitchenwaresPageDescription")}",
