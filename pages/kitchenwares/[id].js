...
const Product = React.memo(({ product, comments }) => (
  <>
    <Head>
      ...
      <meta
        property="og:url"
        content={`https://sticker-next.liara.run/kitchenwares/${product._id}`}
      />
      <meta
        property="og:image"
        content={
      ...
      <link
        rel="canonical"
        href={`https://sticker-next.liara.run/kitchenwares/${product._id}`}
      />
        ...
        {`
          {
            ...
            "url": "https://sticker-next.liara.run/kitchenwares/${product._id}",
            "offers": {
              "@type": "Offer",
              "priceCurrency": "USD",
              "price": "${product.price}",
