  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://sticker-next.liara.run/login-register`}
        />
        <meta
          property="og:image"
          content={`https://sticker-next.liara.run/images/login-register-og-image.jpg`}
        />
        <link
          rel="canonical"
          href={`https://sticker-next.liara.run/login-register`}
        />
          ...
          {`
            {
              ...
              "@type": "WebPage",
              "url": "https://sticker-next.liara.run/login-register",
              "name": "${
                authType === authTypes.LOGIN
                  ? "Login - Ali Store"
                  : "Register - Ali Store"
