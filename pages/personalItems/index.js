  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content="https://alistore.liara.run/personalItems"
        />
        <meta
          property="og:image"
          content="https://alistore.liara.run/images/personalItems-og-image.jpg"
        />
        <link rel="canonical" href="https://alistore.liara.run/personalItems" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "ItemList",
              "url": "https://alistore.liara.run/personalItems",
              ...
              "itemListElement": ${JSON.stringify(
                products.map((product, index) => ({
                  ...
                  position: index + 1,
                  url:
                    "https://alistore.liara.run/personalItems/" + product._id,
                  name: product.name,
