...
function Floorings({ products }) {
  ...
  return (
    <>
      <Head>
        <title>{t("flooringsPageTitle")}</title>
        <meta name="description" content={t("flooringsPageDescription")} />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content={t("flooringsPageTitle")} />
        <meta
          property="og:description"
          content={t("flooringsPageDescription")}
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://alistore.liara.run/floorings"
        />
        <meta
          property="og:image"
          content="https://alistore.liara.run/images/floorings-og-image.jpg"
        />
        <link rel="canonical" href="https://alistore.liara.run/floorings" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "ItemList",
              "url": "https://alistore.liara.run/floorings",
              "name": "${t("flooringsPageTitle")}",
              "description": "${t("flooringsPageDescription")}",
              "itemListElement": ${JSON.stringify(
                products.map((product, index) => ({
                  "@type": "ListItem",
                  position: index + 1,
                  url: "https://alistore.liara.run/floorings/" + product._id,
                  name: product.name,
