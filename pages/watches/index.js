  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://alistore.liara.run/watches" />
        <meta
          property="og:image"
          content="https://alistore.liara.run/images/watches-og-image.jpg"
        />
        <link rel="canonical" href="https://alistore.liara.run/watches" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "ItemList",
              "url": "https://alistore.liara.run/watches",
              ...
              "itemListElement": ${JSON.stringify(
                products.map((product, index) => ({
                  "@type": "ListItem",
                  position: index + 1,
                  url: "https://alistore.liara.run/watches/" + product._id,
                  name: product.name,
      ...
      <BreadcrumbsComponent route="watches" />
